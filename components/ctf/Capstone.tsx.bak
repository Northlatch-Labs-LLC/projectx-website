          ...
          <div className="flex flex-wrap items-center gap-4 border-b border-white/[0.07] bg-white/[0.02] px-8 py-6 md:px-12">
            <span className="flex items-center gap-3">
              ...
              <span className="flex flex-col leading-tight">
                ...
                <span className="text-[0.875rem] text-px-faint">No known solution</span>
              </span>
            </span>

            <span className="ml-auto flex items-baseline gap-2">
              <span className="font-mono text-4xl font-semibold tabular-nums text-px-gold md:text-5xl">
                {challenge.points.toLocaleString('en-US')}
              </span>
              <span className="text-[0.9375rem] text-px-faint">pts</span>
            </span>
          </div>

          <div className="flex flex-col items-center gap-7 px-8 py-12 text-center md:px-12 md:py-16">
            <h3 className="text-gradient-chrome text-display">{challenge.title}</h3>
            ...
            <div className="ring-gradient w-full max-w-2xl rounded-3xl bg-black/40 px-6 py-8">
              ...
              <p className="mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 font-mono text-xl font-medium tabular-nums md:text-2xl">
              ...
              <p className="mt-4 text-[0.875rem] text-px-faint">
            ...
            <div className="w-full max-w-2xl rounded-3xl border border-white/[0.07] bg-black/25 p-6 text-left">
              ...
              <p className="mt-2.5 text-[1.0625rem] leading-[1.65] text-px-text">
                {challenge.objective}
              </p>
            </div>
            ...
            <div className="flex w-full max-w-2xl gap-4 rounded-3xl border border-px-gold/40 bg-px-gold/[0.06] p-6 text-left">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[0.9375rem] leading-[1.65] text-px-muted">
