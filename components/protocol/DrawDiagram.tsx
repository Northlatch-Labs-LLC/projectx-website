...
export function DrawDiagram() {
  ...
  return (
    <div className="panel p-6 md:p-7">
          ...
          {slices.map((slice, index) => {
            ...
            return (
              <span
                ...
                className={`flex items-center justify-center border-r border-px-bg/60 text-[0.7rem] font-medium last:border-r-0 ${
                  winning
      ...
      <div className="mt-8 flex flex-wrap gap-x-8 gap-y-3 text-sm text-px-muted">
        ...
        <span className="font-mono text-xs text-px-faint">O(log n) lookup</span>
      </div>
